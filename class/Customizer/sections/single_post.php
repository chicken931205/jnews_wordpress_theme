...
$options[] = array(
	'id'              => 'jnews_calculate_word_method',
	'transport'       => 'postMessage',
	...
	'choices'         => array(
		'str_word_count' => esc_attr__( 'PHP Word Counter Method', 'jnews' ),
		'count_blank'    => esc_attr__( 'Count the spaces between the words', 'jnews' ),

	),
	'partial_refresh' => array(
		'jnews_calculate_word_method' => $postmeta_refresh,
	),
	'active_callback' => array(
		$postmeta_callback,
		$single_post_callback,

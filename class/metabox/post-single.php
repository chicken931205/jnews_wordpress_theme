...
$options = array(
	...
	'template' => array(
				...
				array(
					...
					'fields'          => array(
						...
						array(
							...
							'default'         => array(
								get_theme_mod( 'jnews_single_blog_template', '1' ),
							),
						),
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_blog_enable_parallax', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => 'in',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_blog_enable_fullscreen', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => 'in',
						...
						array(
							...
							'default'         => array(
								get_theme_mod( 'jnews_single_blog_layout', 'right-sidebar' ),
							),
							'active_callback' => array(
								array(
									'field'    => 'template',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_sticky_sidebar', true ),
							'active_callback' => array(
								array(
									'field'    => 'layout',
									'operator' => 'in',
						...
						array(
							...
							'default'         => array(
								get_theme_mod( 'jnews_single_share_position', 'top' ),
							),
							'active_callback' => array(
								array(
									'field'    => 'template',
						...
						array(
							...
							'default'         => array(
								get_theme_mod( 'jnews_single_share_float_style', 'share-monocrhome' ),
							),
							'active_callback' => array(
								array(
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_share_counter', true ),
							'active_callback' => array(
								array(
									'field'    => 'share_position',
									'operator' => 'in',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_view_counter', true ),
							'active_callback' => array(
								array(
									'field'    => 'share_position',
									'operator' => 'in',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_featured', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => 'in',
									'value'    => array( '1', '2', '3', '7', '8' ),
								),
							),
						),
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_post_meta', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_post_author', true ),
							'active_callback' => array(
								array(
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_post_author_image', true ),
							'active_callback' => array(
								array(
									'field'    => 'show_post_meta',
									'operator' => '==',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_post_date', true ),
							'active_callback' => array(
								array(
									'field'    => 'show_post_meta',
									'operator' => '==',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_category', true ),
							'active_callback' => array(
								array(
									'field'    => 'show_post_meta',
									'operator' => '==',
						...
						array(
							'type'            => 'select',
							'name'            => 'post_calculate_word_method',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_zoom_button', false ),
							'active_callback' => array(
								array(
									'field'    => 'show_post_meta',
									'operator' => '==',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_tag', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_prev_next_post', true ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
						...
						array(
							...
							'default'     => get_theme_mod( 'jnews_single_show_popup_post', true ),
						),
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_author_box', false ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_show_post_related', false ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
						...
						array(
							...
							'default'         => get_theme_mod( 'jnews_single_post_show_inline_related', false ),
							'active_callback' => array(
								array(
									'field'    => 'template',
									'operator' => '!=',
		...
		array(
			'type'   => 'tab',
			'name'   => 'sponsored_post_tab',
			'title'  => esc_html__( 'Sponsored Post', 'jnews' ),
			'fields' => array(
				...
				array(
					'type'            => 'toggle',
					'name'            => 'sponsored_post_logo_enable',
		...
		array(
			'type'   => 'tab',
			'name'   => 'ad_post_tab',
			'title'  => esc_html__( 'Ad Option', 'jnews' ),
			'fields' => array(
				array(
					'type'        => 'toggle',
					'name'        => 'disable_ad',
